...
public class TaxController {
    ...
    @GetMapping("/classes")
    @PreAuthorize("hasAuthority(T(com.stockpilot.backend.org.permissions.TaxConfigPermissions).READ)")
    ...
    @PostMapping("/classes")
    @PreAuthorize("hasAuthority(T(com.stockpilot.backend.org.permissions.TaxConfigPermissions).CREATE)")
    ...
    @PreAuthorize("hasAuthority(T(com.stockpilot.backend.org.permissions.TaxConfigPermissions).UPDATE)")
    ...
    @PreAuthorize("hasAuthority(T(com.stockpilot.backend.org.permissions.TaxConfigPermissions).SET_DEFAULT)")
    ...
    @GetMapping("/resolve")
    @PreAuthorize("hasAuthority(T(com.stockpilot.backend.org.permissions.TaxConfigPermissions).RESOLVE)")
